    ...
    <>
      ...
      <div className="p-4 border-t border-sidebar-border">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-foreground transition-colors w-full"
        >
